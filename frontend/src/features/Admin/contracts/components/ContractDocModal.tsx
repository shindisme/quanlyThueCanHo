          ...
          <div className="bg-gray-50 p-4 sm:p-8 rounded-2xl overflow-y-auto max-h-[70vh] border border-gray-200">
            ...
            >
              ...
              <div className="space-y-4 font-sans text-xs sm:text-sm">
                <p>
                  Hôm nay, ngày {signedDate.getDate()} tháng {signedDate.getMonth() + 1} năm {signedDate.getFullYear()}, tại {bld?.address_new || "văn phòng đại diện Yuki House"}, chúng tôi gồm có:
                </p>
                ...
                <div className="space-y-1">
                  ...
                  <div className="pl-4 space-y-1 text-xs text-gray-700">
                    ...
                    <p>
                      ...
                      tại {bld?.branch_name || "Tòa nhà Yuki House"}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="pl-4 space-y-1 text-xs text-gray-700">
                    ...
                    <div className="pl-4 space-y-0.5">
                      <p>- Địa chỉ căn hộ: {bld?.address_new || "Chưa xác định"}</p>
                ...
                {/* Điều 4 */}
                <div className="space-y-1">
                  <p className="font-semibold text-gray-950 text-xs sm:text-sm">ĐIỀU 4: ĐẶT CỌC</p>
                  <div className="pl-4 space-y-1 text-xs text-gray-700">
                    <p>
                ...
                <div className="space-y-1">
                  ...
                  <div className="pl-4 space-y-1 text-xs text-gray-700">
                    ...
                    <div className="pl-4 space-y-0.5 text-gray-650">
                      <p>– Bàn giao căn hộ and trang thiết bị như thỏa thuận tại Điều 1 Hợp đồng;</p>
