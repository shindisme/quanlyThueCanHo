              ...
              <div className="space-y-4 font-sans text-xs sm:text-sm">
                ...
                <div className="space-y-1">
                  ...
                  <div className="pl-4 text-xs text-gray-700 space-y-1">
                    ...
                    <p>10.3. Các Bên cùng cam kết việc ký kết hợp đồng này giữa các Bên là hoàn toàn tự nguyện, không bị ép buộc, lừa dối. Trong quá trình thực hiện hợp đồng, nếu cần thay đổi hoặc bổ dung nội dung của hợp đồng này thì các Bên thỏa thuận lập thêm phụ lục hợp đồng có chữ ký của hai bên.</p>
